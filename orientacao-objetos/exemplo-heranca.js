...
var Funcionario = (function () {
    ...
    Funcionario.prototype.pagarImpost = function (taxa) {
...
var Executivo = (function (_super) {
    ...
    Executivo.prototype.pagarImpost = function (taxa) {
        if (taxa === void 0) { taxa = 27.5; }
        console.log('Executivo paga mais!');
        _super.prototype.pagarImpost.call(this, taxa);
    };
    return Executivo;
}(Funcionario));
var secretario = new Secretario('João Arthur', 2000);
secretario.pagarImpost();
var executivo = new Executivo('João', 30000);
